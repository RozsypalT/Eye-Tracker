...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.gallerylabel.setGeometry(QtCore.QRect(int(self.window_width/4.5), int(0.5*self.window_height/15), int(self.window_width/10), int(self.window_height/25)))
        self.gallerylabel.setText("Selected pictures:")

        self.imgcountlabel.setGeometry(QtCore.QRect(int(self.window_width / 4.5), int(12.4 * self.window_height / 15), int(self.window_width),int(self.window_height / 25)))
        self.imgcountlabel.setText("Number of selected pictures: " + str(len(self.selected)) + ". " + str(self.x*self.y - len(self.selected)) + " more pictures needed.")

        self.comboboxlabel.setGeometry(QtCore.QRect(int(self.window_width/15), int(2.5*self.window_height/15), int(self.window_width/10), int(self.window_height/25)))
        ...
        self.helpbutton.setGeometry(QtCore.QRect(int(self.window_width/15), int(5*(self.window_height/15)), int(self.window_width/10), int(self.window_height/25)))
        self.helpbutton.setObjectName("pushButton_4")

        self.startbutton.setText("Start")
        self.startbutton.setGeometry(QtCore.QRect(int(self.window_width/3), int(13.5*(self.window_height/15)), int(self.window_width/10), int(self.window_height/25)))
        self.startbutton.setObjectName("pushButton_4")

        self.quitbutton.setText("Quit")
        self.quitbutton.setGeometry(QtCore.QRect(int(self.window_width/1.75), int(13.5*(self.window_height/15)), int(self.window_width/10), int(self.window_height/25)))
        self.quitbutton.clicked.connect(self.quit)
        self.quitbutton.setObjectName("pushButton_4")

        self.layoutbox.setGeometry(QtCore.QRect(int(self.window_width/15), int(3*self.window_height/15), int(self.window_width/10), int(self.window_height/25)))
    ...
    def loadPicture(self, filename):
        ...
        modpixmap = pixmap.scaled(int((self.window_width/1.75)/3.25)-15, int((self.window_height/1.3)/3.175)-15)
